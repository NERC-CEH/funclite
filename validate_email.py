# This is from validate_email on github and is NOT my work.
# Full credit to the original author on github
# Unfortunately the code base was changed which broke all existing check code
# Hence for stability, i've added here to funclite
...
def get_mx_ip(hostname):
    if hostname not in MX_DNS_CACHE:
        try:
            MX_DNS_CACHE[hostname] = DNS.mxlookup(hostname)  # noqa
...
if __name__ == '__main__':
    validate_email('gramon@ceh.ac.uk')
    pass
